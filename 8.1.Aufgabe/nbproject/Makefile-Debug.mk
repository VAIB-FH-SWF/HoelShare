...
${OBJECTDIR}/EnumConverter.o: EnumConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EnumConverter.o EnumConverter.cpp

${OBJECTDIR}/FileNotFoundException.o: FileNotFoundException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileNotFoundException.o FileNotFoundException.cpp

${OBJECTDIR}/HoelShareException.o: HoelShareException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HoelShareException.o HoelShareException.cpp

${OBJECTDIR}/IndexOutOfRangeException.o: IndexOutOfRangeException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndexOutOfRangeException.o IndexOutOfRangeException.cpp

${OBJECTDIR}/InputException.o: InputException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputException.o InputException.cpp
...
${OBJECTDIR}/InvalidPictureException.o: InvalidPictureException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InvalidPictureException.o InvalidPictureException.cpp

${OBJECTDIR}/NotImplementedException.o: NotImplementedException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NotImplementedException.o NotImplementedException.cpp

${OBJECTDIR}/P2PGMPicture.o: P2PGMPicture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/P2PGMPicture.o P2PGMPicture.cpp

${OBJECTDIR}/Picture.o: Picture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Picture.o Picture.cpp

${OBJECTDIR}/PictureFactory.o: PictureFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PictureFactory.o PictureFactory.cpp
