...
${OBJECTDIR}/EnumConverter.o: EnumConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EnumConverter.o EnumConverter.cpp

${OBJECTDIR}/InputHandler.o: InputHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputHandler.o InputHandler.cpp

${OBJECTDIR}/P2PGMPicture.o: P2PGMPicture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/P2PGMPicture.o P2PGMPicture.cpp

${OBJECTDIR}/Picture.o: Picture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Picture.o Picture.cpp

${OBJECTDIR}/PictureFactory.o: PictureFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PictureFactory.o PictureFactory.cpp

${OBJECTDIR}/exception/FileNotFoundException.o: exception/FileNotFoundException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/FileNotFoundException.o exception/FileNotFoundException.cpp

${OBJECTDIR}/exception/HoelShareException.o: exception/HoelShareException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/HoelShareException.o exception/HoelShareException.cpp

${OBJECTDIR}/exception/IndexOutOfRangeException.o: exception/IndexOutOfRangeException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/IndexOutOfRangeException.o exception/IndexOutOfRangeException.cpp

${OBJECTDIR}/exception/InputException.o: exception/InputException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/InputException.o exception/InputException.cpp

${OBJECTDIR}/exception/InvalidPictureException.o: exception/InvalidPictureException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/InvalidPictureException.o exception/InvalidPictureException.cpp

${OBJECTDIR}/exception/NotImplementedException.o: exception/NotImplementedException.cpp 
	${MKDIR} -p ${OBJECTDIR}/exception
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/exception/NotImplementedException.o exception/NotImplementedException.cpp
